...
const s3 = new AWS.S3();
const destinationBucket = process.env.polly_output_bucket_to_english

module.exports.polly_to_english = (event, context) => {
...
function pollyize(lang, text, bucket) {
  ...
  return polly.startSpeechSynthesisTask(params);
};
